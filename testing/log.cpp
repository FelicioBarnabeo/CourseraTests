...
public:
  ...
  void SetLineNumber(int number) {line_number = number;}

  void Log(const string& message)
  {
      if(log_line && log_file) os<<file_name<<":"<<line_number<<" "<<message<<endl;
      else if(log_file) os<<file_name<<" "<<message<<endl;
      else if(log_line) os<<"Line "<<line_number<<" "<<message<<endl;
